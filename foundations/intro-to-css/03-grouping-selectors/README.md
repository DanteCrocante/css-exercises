...
- Does each element have a unique class name? :white_check_mark:
- Did you use the grouping selector for styles that both elements share? :white_check_mark:
- Did you make separate rules for the styles unique to each element? :white_check_mark:

...
### Self Check
- Do the odd numbered `p` elements share a class? :white_check_mark:
- Do the even numbered `div` elements have unique IDs? :white_check_mark:
- Does the Number 3 element have multiple classes? :white_check_mark:
